...
echo "  systemctl --user start issue-tracker-backend issue-tracker-frontend issue-tracker-mcp"
echo ""
echo "Check status:"
echo "  systemctl --user status issue-tracker-backend issue-tracker-frontend issue-tracker-mcp"
